 ...
 char(safe_mod_func_uint8_t_u_u)(char ui1, char ui2) {
...
static void crc32_8bytes(long long int val) {
 ...
 char g_5 ;
static int g_67, g_867  ;
static char func_14(short int p_15, int p_16, char p_17);
 char func_14(short int p_15, int p_16, char p_17) {
  int l_820 = 3L ;
...
int main() {
  ...
  if (func_14(
    ...
    if (l_1057__func_1[1] == 0) for (g_65 = 0; g_65 <= 2; g_65 += 1) {
        g_2 = safe_mod_func_uint8_t_u_u(l_1057__func_1[g_65], g_5) <=
             (l_1057__func_1[g_65] ^ g_867);
        if (g_64) {
          for (; g_2 != 22; ++g_2) {}
          g_137[4][4] =
              0;
