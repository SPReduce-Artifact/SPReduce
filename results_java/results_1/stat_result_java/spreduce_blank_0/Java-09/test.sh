...
class="compiler.runtime.Test6892265"
...
cp Test6892265.java compiler/runtime/Test6892265.java
python3 $javaMender $script_dir/compiler/runtime/Test6892265.java
if ! /01JVMS/linux64/openjdk11/openj9_11/bin/javac -cp $classpath compiler/runtime/Test6892265.java
then
        exit 1
fi
