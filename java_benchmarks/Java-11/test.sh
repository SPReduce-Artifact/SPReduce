...
python3 $javaMender $script_dir/TestByteArrays.java
if ! /01JVMS/linux64/openjdk11/openj9_11/bin/javac -cp $classpath TestByteArrays.java
then
        exit 1
fi
# __MARK:C__
