...
class="jit.FloatingPoint.gen_math.Loops03.Loops03"
...
mkdir -p jit/FloatingPoint/gen_math/Loops03
cp Loops03.java jit/FloatingPoint/gen_math/Loops03/Loops03.java
python3 $javaMender $script_dir/jit/FloatingPoint/gen_math/Loops03/Loops03.java
if ! /01JVMS/linux64/openjdk11/openj9_11/bin/javac -cp $classpath jit/FloatingPoint/gen_math/Loops03/Loops03.java
then
        exit 1
fi
# __MARK:C__
