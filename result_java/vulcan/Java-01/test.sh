...
python3 $javaMender $script_dir/TestMemoryPools.java
if ! /01JVMS/linux64/openjdk11/openj9_11/bin/javac -cp $classpath TestMemoryPools.java
then
        exit 1
fi
