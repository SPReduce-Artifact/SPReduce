...
python3 $javaMender $script_dir/TestElasticTLAB.java
if ! /01JVMS/linux64/openjdk11/openj9_11/bin/javac -cp $classpath TestElasticTLAB.java
then
        exit 1
fi
